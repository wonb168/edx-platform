...
class GradebookView(GradeViewMixin, PaginatedAPIView):
    ...
    **Paginated GET response**
        ...
        * filtered_users_count: The total number of active users that match the filter associated with the provided query parameters.
    ...
    def _get_users_counts(self, course_key, course_enrollment_filters):
        ...
        Returns:
            dict:
                ...
                filtered_users_count: the number of active users in the course that match the given course_enrollment_filters
        """
        filter_args = [
        ...
        filtered_users_count = CourseEnrollment.objects.filter(*filter_args).count()
